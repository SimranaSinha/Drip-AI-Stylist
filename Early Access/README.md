...
- [ ] Wardrobe upload (photo → outfit suggestions)
- [ ] Shop links for recommended pieces
...
This is an early access project — feedback is gold! If you find bugs, have feature ideas, or want to contribute:

1. Open an [Issue](https://github.com/SimranaSinha/Drip-AI-Stylist/issues)
2. Fork → branch → PR
3. Or just [try the app](https://drip-style1.netlify.app) and share your thoughts!
